...
module.exports = function (moduleOptions) {
  ...
  if (auth && auth.ssr) {
        ...
        if (res && res.locals && res.locals._session) {
          ...
          if (elapsed >= sessionLifetime) {
            try {
              ...
              /* @TODO: investigate what causes firebase app deleted error
               * Current suspicion:
    ...
    // addPlugin ssrAuth is called after addPlugin serverLogin
    // so res object ist augmented before server login is attempted
    this.addPlugin({
