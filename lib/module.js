  ...
  if (messagingSW || authSW) {
    this.nuxt.hook('build:before', async () => {
      ...
      const { dst } = this.addTemplate({
        src: resolve(__dirname, 'templates/workbox-extension-plugin.js'),
        fileName: 'firebase-module/workbox/plugin-extension.js',
        options: { config: options.config, messaging: messagingSW }
      })
      ...
      if (messagingSW) {
        ...
        const { dst } = this.addTemplate({
          src: resolve(__dirname, 'templates/workbox-extension-messaging.js'),
          fileName: 'firebase-module/workbox/messaging-extension.js',
          options: {
            firebaseVersion,
        ...
        this.options.pwa.workbox.workboxExtensions.push(dst)
      }
      ...
      if (authSW) {
        ...
        // Add Service-Worker
        const { dst } = this.addTemplate({
          src: resolve(__dirname, 'templates/workbox-extension-auth.js'),
          fileName: 'firebase-module/workbox/auth-extension.js',
          options: {
