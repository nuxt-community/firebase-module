...
module.exports = function (moduleOptions) {
  ...
  if (auth && auth.ssr) {
    ...
    this.addTemplate({
      src: resolve(__dirname, 'templates/sessionManager.js'),
      fileName: 'firebase-module/sessionManager.js',
  ...
  if (credential) {
    // this plugin has to be included last
    // so res object ist augmented for other plugins
    this.addPlugin({
